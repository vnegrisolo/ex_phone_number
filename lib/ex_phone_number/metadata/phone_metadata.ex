defmodule ExPhoneNumber.Metadata.PhoneMetadata do
  ...
  def from_xpath_node(xpath_node) do
    kwlist =
      ...
      |> xmap(
        ...
        premium_rate:
          ~x"./premiumRate"e |> transform_by(&PhoneNumberDescription.from_xpath_node/1),
  ...
  def put_default_values(phone_metadata = %PhoneMetadata{}) do
    ...
    phone_metadata = %{
      phone_metadata
      | toll_free:
          process_other_phone_number_description(phone_metadata.toll_free, phone_metadata)
    }
    ...
    phone_metadata = %{
      phone_metadata
      | voicemail:
          process_other_phone_number_description(phone_metadata.voicemail, phone_metadata)
    }
  ...
  def get_number_format(%{number_format: number_format}, %PhoneMetadata{} = phone_metadata) do
    ...
    Logger.debug(
      "\tnational_prefix_formatting_rule: #{
        inspect(number_format.national_prefix_formatting_rule)
      }"
    )
