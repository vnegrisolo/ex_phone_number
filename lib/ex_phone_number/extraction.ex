        ...
        if String.starts_with?(full_number, country_code_string) do
          ...
          if (not matches_entirely?(metadata.general.national_number_pattern, full_number) and
               ...
               test_number_length_against_pattern(
                 metadata.general.possible_number_pattern,
                 full_number
            ...
            {true, potential_national_number,
             %{phone_number | country_code: metadata.country_code}}
          else
    ...
    case Regex.run(prefix_pattern, number) do
      ...
      matches ->
        ...
        if no_transform do
          ...
          transformed_number =
            Regex.replace(prefix_pattern, number, national_prefix_transform_rule)
